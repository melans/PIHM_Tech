...
![The screenshort of input files for PIHM++](Fig/IO/Inputfiles.png)
...
There are two tables in the .mesh file, the one is table of elements and the other is table of nodes of elements.
...
- Line 2: Directory to spreadsheet
